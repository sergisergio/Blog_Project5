...
<html lang="fr">
    ...
    <body class="full-layout">
        ...
        <div class="body-wrapper">
            ...
            <div class="container">
                <?php require "App/frontend/Modules/Home/section1_portfolio.php"; ?>
                <?php require "App/frontend/Modules/Home/section2_about.php"; ?>
                <?php require "App/frontend/Modules/Home/section3_skills.php"; ?>
                <section id="contact">
                    <div class="box">
                        ...
                        <div class="form-container">
                            ...
                            <?php require "App/frontend/Modules/Home/form_contact.php"; ?>
                        </div>
                    </div>
                </section>

      ...
      <div class="box">
        ...
        <div id="grid-container" class="cbp-l-grid-masonry">
          <ul>
            ...
            <li class="cbp-item frame html"> <a class="cbp-caption" href="http://mozaique.lille.free.fr/" target="_blank">
            ...
            <li class="cbp-item frame html"> <a class="cbp-caption " href="http://onfaitnotre.com/" target="_blank">
            ...
            <li class="cbp-item frame html"> <a class="cbp-caption "  href="http://tymariewordpress2.philippetraon.com" target="_blank">
            ...
            <li class="cbp-item frame php"> <a class="cbp-caption " href="http://www.soltexpertiz.com/" target="_blank">

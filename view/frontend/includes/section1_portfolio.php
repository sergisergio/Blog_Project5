<section id="portfolio" class="portfolio">
                <div class="box">
                    ...
                    <div id="filters-container" class="cbp-l-filters-alignRight pull-right">
                        ...
                        <!--<div data-filter=".integration" class="cbp-filter-item-custom btn">Maquettes</div>--></div>
                    <!-- /#filters-container -->
                        ...
                        <ul>
                                    ...
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                                                <div class="cbp-l-caption-title">Projet Wordpress</div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <li class="cbp-item frame html">
                                <a class="cbp-caption" href="http://mozaique.lille.free.fr/" target="_blank">
                                    <div class="cbp-caption-defaultWrap"> <img src="public/images/logo-blanc.png" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                            ...
                            <li class="cbp-item frame html">
                                <a class="cbp-caption " href="http://onfaitnotre.com/" target="_blank">
                                    <div class="cbp-caption-defaultWrap"> <img src="public/images/OnFaitNotreComHD.jpg" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                            ...
                            <li class="cbp-item frame html">
                                <a class="cbp-caption " href="http://tymariewordpress2.philippetraon.com/" target="_blank">
                                    <div class="cbp-caption-defaultWrap"> <img src="public/images/logo2.jpeg" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                            ...
                            <li class="cbp-item frame php">
                                <a class="cbp-caption " href="http://www.soltexpertiz.com/" target="_blank">
                                    <div class="cbp-caption-defaultWrap"> <img src="public/images/logo_final.png" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                    ...
                    <!-- /.cbp-l-grid-masonry -->
                    <div class="cbp-l-loadMore-button"> <a href="detail/port1-more.php" class="cbp-l-loadMore-button-link btn">VOIR PLUS</a> </div>
                </div>
                <!-- /.box -->
            </section>
            <!-- /#portfolio -->
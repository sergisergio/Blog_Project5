<footer class="footer box">
    ...
    <ul class="social pull-right">
        ...
        <li>
            <a href="https://www.linkedin.com/in/philippe-traon-2031ab118/" target="_blank"><i class="icon-s-linkedin"></i></a>
        </li>
        <li>
            <a href="https://github.com/sergisergio" target="_blank"><i class="fa fa-github"></i></a>
        </li>
        <li>

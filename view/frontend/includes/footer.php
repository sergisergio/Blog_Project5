<footer class="footer box">
    <p class="pull-left">
        <btn class="btn btn-default"><a href="index.php?action=admin">Administration</a></btn>
    </p>
    <ul class="social pull-right">
        ...
        <li><a href="https://github.com/sergisergio" target="_blank"><i class="fa fa-github"></i></a></li>
        <li><a href="https://www.youtube.com/channel/UCNSAyQeQ132taTopmXCKSvQ/playlists" target="_blank"><i class="icon-s-youtube"></i></a></li>
        <li><a href="https://www.freecodecamp.com/sergisergio" target="_blank"> <i class="fa fa-free-code-camp"></i></a></li>

    <?php $title = 'Mon blog'; ?>
        <?php ob_start(); ?>
          ...
          ?>
                    ...
                    ?>
                                                                <!--<span class="comments"><a href="#">8 <i class="icon-chat-1"></i></a></span>--></div>
                                                        <h2 class="post-title"><?= htmlspecialchars($data['title']); ?></h2>
                                                        <h3 class="post-title">Auteur : <?= ($data['author']); ?></h3> <img src="<?= $data['file_extension']; ?>" class="img-responsive" />
                                                        <p>
